...
class Plugin implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        return [
            'Composer\Plugin\Capability\CommandProvider' => 'EasyBaiduComposer\Commands\Provider',
        ];
    }
    ...
    {
        if ($event->getOperation()->getPackage()->getName() === 'larva/easybaidu') {
