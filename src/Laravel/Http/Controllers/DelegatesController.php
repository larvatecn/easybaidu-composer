...
namespace EasyBaiduComposer\Laravel\Http\Controllers;

use EasyBaiduComposer\Delegation\Hydrate;
...
class DelegatesController
{
     ...
     * @param \EasyBaiduComposer\Encryption\DefaultEncrypter $encrypter
     *
